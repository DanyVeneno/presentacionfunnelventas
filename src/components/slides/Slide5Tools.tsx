...
import { FaGlobe, FaChartLine, FaUsers, FaCog, FaRocket, FaMobile } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="inline-flex items-center bg-gradient-to-r from-blue-800/50 to-purple-800/50 backdrop-blur-sm rounded-full px-6 py-2 border border-cyan-400/30">
            ...
            <span className="text-cyan-400 font-medium">https://mlqk6ogdwh.space.minimax.io</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <h4 className="text-lg font-semibold text-white mb-3">Herramienta Práctica</h4>
            ...
            <div>
              <div className="text-4xl mb-4">🚀</div>
              <h4 className="text-lg font-semibold text-white mb-3">Implementación Inmediata</h4>
              <p className="text-blue-200 text-sm">
            ...
            <div>
              <div className="text-4xl mb-4">💎</div>
              <h4 className="text-lg font-semibold text-white mb-3">Diferenciación Competitiva</h4>
              <p className="text-blue-200 text-sm">
